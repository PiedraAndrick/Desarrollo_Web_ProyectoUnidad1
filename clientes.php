...
$query = "SELECT id_usuario, nombres, apellidos, telefono, direccion, cedula FROM clientes";
...
<body  style="background-color:#FFE0C0">
    <div> 
       <h2 class="tittle-clientes">Clientes</h2>
       <h4><a class="boton_agregar" href= "agclientes.php"> Agregar Cliente</a> </h4>
             ...
             <tbody>
                ...
                if($result->num_rows >0){
                    while($row = $result -> fetch_assoc()){
                        ...
                        echo  '<a  class="boton_editar" href="actclientes.php?id='. $row['id_usuario'].'"><i class="fas fa-user-edit"></i></a>';
                        echo '<a class="boton_eliminar" href="eliminarclientes.php?id='.$row['id_usuario'].'" class="tabla-datos"> <i class="fas fa-user-times"></i> </a>';
                    }
                    $result -> free();
                } else 
