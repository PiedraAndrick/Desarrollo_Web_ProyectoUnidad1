...
$query = "SELECT id_prestamos, id_usuario, id_bicicleta, fecha_salida, fecha_devolucion FROM prestamos";
...
<body style="background-color:#FFE0C0">
    <div> 
       <h2 class="tittle-clientes">Prestamos</h2>
       <h4><a class="boton_agregar" href= "aggprestamos.php">Agregar prestamos</a> </h4>
             ...
             <tbody>
                ...
                if($result->num_rows >0){
                    while($row = $result -> fetch_assoc()){
                        ...
                        echo "<td>". $row['id_bicicleta']. "</td>";
                        echo "<td>". $row['fecha_salida']. "</td>";
                        echo "<td>". $row['fecha_devolucion']. "</td>";
                        echo "<td>";
                        echo  '<a  class="boton_editar" href="editprestamos.php?id='. $row['id_prestamos'].'"><i class="fas fa-user-edit"></i></a>';
                        echo '<a class="boton_eliminar" href="eliminarprestamos.php?id='.$row['id_prestamos'].'" class="tabla-datos"> <i class="fas fa-user-times"></i> </a>';
                    }
                    $result -> free();
                } else 
